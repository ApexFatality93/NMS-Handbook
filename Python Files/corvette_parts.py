...
output_json_file = './JSON_Files/Corvette_Parts_Table.json'
...
for product in root.findall('.//Property[@value="GcProductData"]'):
    ...
    corvette_category = data.get('CorvettePartCategory', {}).get('CorvettePartCategory', '')

    if product_id and corvette_category != 'None':
...
print(f"✅ Corvette part data written to: {output_json_file}")
print(f"🧾 Total Corvette parts: {len(product_data_dict)}")

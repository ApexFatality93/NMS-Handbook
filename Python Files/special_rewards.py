...
# --- CONFIG ---
expeditions_mxml = './Game Files/UNLOCKABLESEASONREWARDS.MXML'
twitch_mxml = './Game Files/UNLOCKABLETWITCHREWARDS.MXML'
...
output_json_file = './JSON Files/Special_Rewards_Table.json'

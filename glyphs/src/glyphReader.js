    ...
    if (file) {
        ...
        reader.onload = function () {
            ...
            glyph.screenshot.onload = function () {
                glyph.dispLoc[0].style.display = "block";
                document.getElementById("glyph-reminder").style.display = "block";
...
Glyph.prototype.extractGlyphs = function () {
    ...
    Promise.all(p).then(res => {
        ...
        // Trigger input update manually to show copy link button
        const inputEvent = new Event('input', { bubbles: true });
        document.getElementById("textInput").dispatchEvent(inputEvent);
